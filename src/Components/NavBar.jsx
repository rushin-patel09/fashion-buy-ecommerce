...
const NavBarList = () => {
  ...
  return (
    <>
      <NavLink to="/shop" style={navlinkActive} className="px-5">
        Shop
      </NavLink>
      <NavLink to="/men" style={navlinkActive} className="px-5">
        Men
      </NavLink>
      <NavLink to="/women" style={navlinkActive} className="px-5">
        Women
      </NavLink>
      <NavLink to="/kids" style={navlinkActive} className="px-5">
        Kids
      </NavLink>
      <NavLink
        to="/login"
